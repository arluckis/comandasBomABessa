    ...
    <>
      ...
      `}>
         ...
         <div className="flex-1 overflow-y-auto overflow-x-hidden px-4 xl:px-3 py-4 [&::-webkit-scrollbar]:hidden flex flex-col gap-6 xl:gap-5">
            ...
            <div className="flex flex-col gap-1">
              <p className={`px-2 xl:px-3 text-[10px] font-bold uppercase tracking-widest mb-1 whitespace-nowrap ${isDark ? 'text-zinc-500' : 'text-zinc-400'} xl:opacity-0 xl:h-0 group-hover/sidebar:xl:h-auto group-hover/sidebar:xl:opacity-100 transition-all duration-200`}>Sistema</p>
              <div className="hidden xl:block h-px w-5 mx-auto bg-current opacity-10 mb-1.5 mt-0.5 group-hover/sidebar:xl:hidden transition-opacity"></div>
         ...
         <div className={`mt-auto shrink-0 overflow-hidden transition-colors duration-300 pb-4 xl:pb-3`}>
            <div className="px-4 xl:px-3 pt-3 flex flex-col gap-1">
               <div className={`flex items-center px-3 py-2.5 rounded-[10px] xl:rounded-lg mb-2 xl:justify-center group-hover/sidebar:xl:justify-start ${isDark ? 'bg-white/[0.02] border border-white/[0.05]' : 'bg-black/[0.02] border border-black/[0.05]'}`}>
                 ...
                 <div className={`flex flex-col min-w-0 ml-3 xl:opacity-0 xl:w-0 group-hover/sidebar:xl:w-auto group-hover/sidebar:xl:opacity-100 transition-opacity duration-200 delay-75`}>
                    ...
                    <span className={`text-[10px] flex items-center gap-1.5 font-medium truncate mt-1 tracking-wide ${isDark ? 'text-zinc-500' : 'text-zinc-500'}`}>
                      ...
                      <span className={`px-1 rounded-[3px] text-[8px] uppercase tracking-wider font-bold ${isDark ? 'bg-white/10 text-white' : 'bg-black/5 text-black'}`}>
               ...
               {/* Aqui mantemos o temaNoturno global para que o ícone e texto do botão mostrem a realidade global */}
